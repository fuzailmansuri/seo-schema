...
def build_dataframe_fast(channel_videos_url: str, gemini_key: str = "", model_name: str = "", max_workers: int = 15) -> pd.DataFrame:
    """
...
def scrape_channel_to_excel(channel_url: str, output_path: str) -> None:
    ...
    df = build_dataframe_fast(channel_url, gemini_key="", model_name="", max_workers=15)
...
def main():
    ...
    try:
        ...
        df = build_dataframe_fast(url, gemini_key=args.gemini_key or "", model_name=args.model, max_workers=15)
